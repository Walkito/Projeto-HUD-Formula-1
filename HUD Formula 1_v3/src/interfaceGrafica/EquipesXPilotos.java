...
import interfaceGrafica.hud.TelaPrincipal;
...
public class EquipesXPilotos extends JFrame implements ActionListener{
	...
	public static DefaultListModel listaRelacao = new DefaultListModel();
	@SuppressWarnings("rawtypes")
	...
	JButton btnAvancar = conexaoComponentes.criarJButton(new JButton("Criar"), 355,85,95,20);
	...
	public void adicionarLista() {
		...
		int nPilotos = Integer.parseInt(OpcoesCampeonato.txtFPilotos.getText());
		int nEquipes = Integer.parseInt(OpcoesCampeonato.txtFEquipes.getText());
		
		if (listaExcluidos.size() == nPilotos && listaExcluidos2.size() == nEquipes) {
