...
public class OpcoesCampeonato extends JFrame implements ActionListener{
	...
	public static JTextField txtFPilotos = Componentes.criarJTextField(new JTextField(), 135, 35, 50, 25);
	public static JTextField txtFEquipes = Componentes.criarJTextField(new JTextField(), 135, 105, 50, 25);
