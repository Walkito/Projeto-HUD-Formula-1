...
public class Fontes {
	...
	public Font equipeGrande;
	public Font nomeGrande;
	public Font sobreNomeGrande;
	...
	equipeGrande = Font.createFont(Font.TRUETYPE_FONT, getClass().getResourceAsStream(F1Negrito)).deriveFont(Font.BOLD, 40);
	nomeGrande = Font.createFont(Font.TRUETYPE_FONT, getClass().getResourceAsStream(F1Normal)).deriveFont(Font.BOLD, 30);
	sobreNomeGrande = Font.createFont(Font.TRUETYPE_FONT, getClass().getResourceAsStream(F1Normal)).deriveFont(Font.BOLD, 45);
	}
