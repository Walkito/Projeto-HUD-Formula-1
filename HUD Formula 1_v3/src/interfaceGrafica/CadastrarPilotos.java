...
public class CadastrarPilotos extends JFrame implements ActionListener {
	...
	public static Dictionary<String, String> paisesPilotos = new Hashtable<String, String>();
	
	String[] boxModel = {"África","Alemanha","Angola","Argentina","Austrália","Austria","Azerbaijão","Bahrain","Bélgica","Bolívia","Brasil",
	"Bulgária","Camarões","Canadá","Chile","China","Colombia","Coréia do Sul","Costa do Marfim","Costa Rica","Croácia","Dinamarca","Ecuador","Egito","Escócia",
	"Espanha","Estados Unidos","Finlândia","França","País de Gales","Gana","Grécia","Holanda","Hungria","Índia","Inglaterra","Irlanda","Israel",
	"Itália","Japão","México","Mônaco","Noruega","Paraguai","Peru","Polônia","Portugal","República Tcheca","Rússia","Suécia","Suíça","Uruguai",
	"Venezuela"};
	
	@SuppressWarnings({ "rawtypes", "unchecked" })
	JComboBox boxPaises = conexaoComponentes.criarJCBox(new JComboBox(boxModel), 332, 47, 100, 20);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == btnInserir) {
			if(nomePilotos.size() <= limite) {
				...
				paisesPilotos.put(this.txtFPiloto.getText(), (String) boxPaises.getSelectedItem());
				txtFPiloto.setText("");
			} else {
